...
<script type="text/javascript" src="${base}/lib/jquery.validation/1.14.0/jquery.validate.min.js"></script>
<script type="text/javascript" src="${base}/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="${base}/lib/jquery.validation/1.14.0/messages_zh.min.js"></script>
...
<link rel="stylesheet" type="text/css" href="${base}/lib/layer/2.4/skin/layer.css">
<!--[if IE 6]>
